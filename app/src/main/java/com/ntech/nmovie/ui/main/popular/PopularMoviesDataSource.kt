...
class PopularMoviesDataSource : PageKeyedDataSource<Int, MovieResults>(){
    ...
    override fun loadInitial(
        ...
        apiService.getPopularMovies(page).enqueue(object: Callback<MovieResponse> {
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, MovieResults>) {
        apiService.getPopularMovies(params.key).enqueue(object: Callback<MovieResponse> {
